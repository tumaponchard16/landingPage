            ...
            <div className="col-md-10 mx-auto">
              ...
              <Card className="privacy-card">
                ...
                <p>
                  ...
                  feugiat in id ante. Aliquam nunc dolor, volutpat dapibus
                  auctor vel, commodo efficitur felis. Vivamus eu auctor nisl,
                  id interdum turpis. In purus felis, finibus id nisl in,
                  egestas congue ipsum.
                </p>
                ...
                <div>
                  ...
                  <p>
                    ...
                    can provide you with products and services. We treat all
                    your personal information confidentially, and protecting
                    your privacy is central to all of our services.
                  </p>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Curabitur quam nunc, egestas a vestibulum vitae, iaculis id
                    tortor. Phasellus mi metus, finibus vel pretium sed,
                    sagittis porttitor augue. Cras nulla nisi, facilisis sed
                    ante in, vehicula volutpat ex. Donec quis lectus ac elit
                    suscipit feugiat in id ante.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    mauris pretium finibus. Donec orci orci, sollicitudin eu
                    nulla id, convallis lacinia quam. Proin malesuada nibh ut
                    ullamcorper mollis.
                  </p>
                  ...
                  <p>
                    ...
                    massa ultrices, laoreet ex lobortis, auctor enim. Sed
                    molestie vehicula porta.{" "}
                  </p>
                  ...
                  <p>
                    ...
                    Fusce lacinia augue tincidunt felis vehicula ultrices. Ut
                    urna dui, hendrerit vel convallis non, vulputate varius
                    erat. In eu justo fermentum, tempus magna sit amet, volutpat
                    metus. Cras et pellentesque lacus.
                  </p>

                  <p>
                    Aenean volutpat felis at lectus pellentesque, ac dapibus dui
                    congue. Etiam vitae volutpat libero. Suspendisse vel
                    volutpat dui, quis facilisis enim. Sed sagittis tortor
                    vulputate, commodo ligula vel, molestie elit. Aliquam
                    tristique lacus a sapien rutrum, et imperdiet nisl molestie.
